"""
Totally same to model8, but the configures ABCDE are different.
...
def model9A(num_classes=40, **kwargs) -> Model9:
    return Model9(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[2,2,2], pos_blocks=[2,2,2], k_neighbors=[32,32,32],
                 reducers=[2,2,2], **kwargs)

def model9B(num_classes=40, **kwargs) -> Model9:
    return Model9(points=1024, class_num=num_classes, embed_dim=32,
                 pre_blocks=[2,2,2], pos_blocks=[2,2,2], k_neighbors=[32,32,32],
                 reducers=[2,2,2], **kwargs)

def model9C(num_classes=40, **kwargs) -> Model9:
    return Model9(points=1024, class_num=num_classes, embed_dim=32,
                 pre_blocks=[4,4,4], pos_blocks=[2,2,2], k_neighbors=[32,32,32],
                 reducers=[2,2,2], **kwargs)

def model9D(num_classes=40, **kwargs) -> Model9:
    return Model9(points=1024, class_num=num_classes, embed_dim=32,
                 pre_blocks=[4,4,4], pos_blocks=[2,2,2], k_neighbors=[20,20,20],
                 reducers=[2,2,2], **kwargs)

def model9E(num_classes=40, **kwargs) -> Model9:
    return Model9(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[4,4,4], pos_blocks=[2,2,2], k_neighbors=[20,20,20],
                 reducers=[2,2,2], **kwargs)
