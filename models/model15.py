...
class Model15(nn.Module):
    def __init__(self, points=1024, class_num=40, embed_dim=64,
        ...
        for i in range(len(pre_blocks)):
            ...
            pre_block_module = PreExtraction(out_channel, pre_block_num, heads=heads, dim_head=dim_head)
...
def model15A(num_classes=40, **kwargs) -> Model15:  # 20695MiB
...
def model15B(num_classes=40, **kwargs) -> Model15:  # 10817MiB
    return Model15(points=1024, class_num=num_classes, embed_dim=64,
                  pre_blocks=[2, 2, 2], pos_blocks=[2, 2, 2], k_neighbors=[32, 32, 32],
                  reducers=[4, 2, 2], **kwargs)


def model15C(num_classes=40, **kwargs) -> Model15:  # 25261MiB
    return Model15(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[4,4,4], pos_blocks=[4,4,4], k_neighbors=[32,32,32],
                 reducers=[2,2,2], **kwargs)


def model15D(num_classes=40, **kwargs) -> Model15:  # 32305MiB
    return Model15(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[2,2,2], pos_blocks=[2,2,2], k_neighbors=[48,48,48],
                 reducers=[2,2,2], **kwargs)


def model15E(num_classes=40, **kwargs) -> Model15:
    return Model15(points=1024, class_num=num_classes, embed_dim=64,
...
def model15Lite_A(num_classes=40, **kwargs) -> Model15:  # 7335MiB
    return Model15(points=1024, class_num=num_classes,embed_dim=64,
...
def model15Lite_D(num_classes=40, **kwargs) -> Model15:  # 9767MiB
    return Model15(points=1024, class_num=num_classes,embed_dim=64,
...
def model15Lite_G(num_classes=40, **kwargs) -> Model15:  # 7831MiB
    return Model15(points=1024, class_num=num_classes,embed_dim=48,
                 pre_blocks=[2,3,2], pos_blocks=[2,3,2], k_neighbors=[32,16,8],
                 reducers=[4,4,4], **kwargs)


def model15Lite_H(num_classes=40, **kwargs) -> Model15:  # 5745MiB
    return Model15(points=1024, class_num=num_classes,embed_dim=64,
