...
class Combine1CUDA(nn.Module):
    def __init__(self, num_classes=40, use_normals=False, points=512,
        ...
        super(Combine1CUDA, self).__init__()
...
def combine1ACUDA(num_classes=40, **kwargs: Any) -> Combine1CUDA:
    return Combine1CUDA(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, **kwargs)

def combine1AmaxCUDA(num_classes=40, **kwargs: Any) -> Combine1CUDA:
    return Combine1CUDA(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, pool="max", **kwargs)

def combine1BmaxCUDA(num_classes=40, **kwargs: Any) -> Combine1CUDA:
    return Combine1CUDA(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, embed_channel=64, pool="max", **kwargs)

def combine1CmaxCUDA(num_classes=40, **kwargs: Any) -> Combine1CUDA:
    return Combine1CUDA(num_classes=num_classes, blocks=[1, 1, 1, 1],
