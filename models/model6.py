...
class Model6(nn.Module):
    def __init__(self, points=1024, class_num=40, embed_dim=64, heads=4, dim_head=32,
        ...
        for i in range(len(pre_blocks)):
            ...
            pre_block_module = PreExtraction(last_channel, pre_block_num, heads=self.heads, dim_head=self.dim_head)
            self.pre_blocks_list.append(pre_block_module)
            local_token = nn.Parameter(torch.rand([1,1,1,last_channel]))
...
def model6A(num_classes=40, **kwargs) -> Model6:
...
def model6B(num_classes=40, **kwargs) -> Model6:
    return Model6(points=1024, class_num=num_classes, embed_dim=64, heads=4, dim_head=32,
                 pre_blocks=[2,2,2], pos_blocks=[2,2,2], k_neighbors=[16,16,16],
                 reducers=[2,2,2], **kwargs)

def model6C(num_classes=40, **kwargs) -> Model6:
    return Model6(points=1024, class_num=num_classes, embed_dim=64, heads=4, dim_head=24,
                 pre_blocks=[2,2,2], pos_blocks=[2,2,2], k_neighbors=[32,32,32],
                 reducers=[2,2,2], **kwargs)

def model6D(num_classes=40, **kwargs) -> Model6:
    return Model6(points=1024, class_num=num_classes, embed_dim=64, heads=4, dim_head=32,
                 pre_blocks=[3,3,3], pos_blocks=[1,1,1], k_neighbors=[32,32,32],
                 reducers=[2,2,2], **kwargs)

def model6E(num_classes=40, **kwargs) -> Model6:
    return Model6(points=1024, class_num=num_classes, embed_dim=64, heads=4, dim_head=32,
                 pre_blocks=[2,2,2], pos_blocks=[2,2,2], k_neighbors=[16,16,16],
...
if __name__ == '__main__':
    ...
    print("===> testing model6A ...")
    model = model6A()
    out = model(data)
    print(out.shape)

    print("===> testing model6B ...")
    model = model6B()
    out = model(data)
    print(out.shape)

    print("===> testing model6C ...")
    model = model6C()
    out = model(data)
    print(out.shape)
