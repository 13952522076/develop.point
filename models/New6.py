"""
Based on new6: consider the coords in different ways
Based on new1: add encoded(coords) to features
Including:
...
class TransformerBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        att = self.attention(features+pos)
        att = att + features
...
def new6A(num_classes=40, **kwargs: Any) -> New6:
    return New6(num_classes=num_classes, blocks=[2, 2, 2, 2], reducer=4, k_neighbors=[32,32,32,32], **kwargs)

def new6B(num_classes=40, **kwargs: Any) -> New6:
    return New6(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, k_neighbors=[32,32,32,32], **kwargs)

def new6C(num_classes=40, **kwargs: Any) -> New6:
    return New6(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, k_neighbors=[16,16,16,16], **kwargs)


def new6D(num_classes=40, **kwargs: Any) -> New6:
    return New6(num_classes=num_classes, blocks=[2, 3, 6, 4], reducer=4, k_neighbors=[32,32,32,32], **kwargs)

def new6E(num_classes=40, **kwargs: Any) -> New6:
    return New6(num_classes=num_classes, embed_channel=64, blocks=[1,1,1,1], reducer=4, k_neighbors=[32,32,32,32], **kwargs)
