...
class LocalGather(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.operation = nn.Sequential(
            FCBNReLU1D(in_channels=in_channels, out_channels=out_channels),
            FCBNReLU1D(in_channels=out_channels, out_channels=out_channels)
        )
...
class PreExtraction(nn.Module):
    def __init__(self, channels, blocks=1):
        ...
        for _ in range(blocks):
            operation.append(
                FCBNReLU1D(in_channels=channels, out_channels=channels)
            )
...
def modelA(num_classes=40, **kwargs) -> Model:
    return Model(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[1,1,1,1], pos_blocks=[1,1,1,1], k_neighbors=[32,32,32,32],
                 reducers=[2,2,2,2], **kwargs)

def modelB(num_classes=40, **kwargs) -> Model:
    return Model(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[1,1,1], pos_blocks=[1,1,1], k_neighbors=[32,32,32],
                 reducers=[2,2,2], **kwargs)


def modelC(num_classes=40, **kwargs) -> Model:
    return Model(points=1024, class_num=num_classes, embed_dim=32,
                 pre_blocks=[1,1,1,1], pos_blocks=[1,1,1,1], k_neighbors=[32,32,32,32],
                 reducers=[2,2,2,2], **kwargs)

def modelD(num_classes=40, **kwargs) -> Model:
    return Model(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[2,2,2,2], pos_blocks=[2,2,2,2], k_neighbors=[32,32,32,32],
                 reducers=[2,2,2,2], **kwargs)


def modelE(num_classes=40, **kwargs) -> Model:
    return Model(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[2,2,2], pos_blocks=[2,2,2], k_neighbors=[32,32,32],
                 reducers=[2,2,2], **kwargs)

def modelF(num_classes=40, **kwargs) -> Model:
    return Model(points=1024, class_num=num_classes, embed_dim=32,
                 pre_blocks=[1,1,1,1], pos_blocks=[1,1,1,1], k_neighbors=[32,16,8,4],
                 reducers=[4,4,4,4], **kwargs)
