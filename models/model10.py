...
def model10A(num_classes=40, **kwargs) -> Model10:
    return Model10(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[2,2,2], pos_blocks=[2,2,2], k_neighbors=[32,32,32],
                 reducers=[4,2,2], **kwargs)

def model10B(num_classes=40, **kwargs) -> Model10:
    return Model10(points=1024, class_num=num_classes, embed_dim=32,
                 pre_blocks=[2,2,2], pos_blocks=[2,2,2], k_neighbors=[32,32,32],
                 reducers=[4,2,2], **kwargs)

def model10C(num_classes=40, **kwargs) -> Model10:
    return Model10(points=1024, class_num=num_classes, embed_dim=32,
                 pre_blocks=[4,4,4], pos_blocks=[2,2,2], k_neighbors=[32,32,32],
                 reducers=[4,2,2], **kwargs)

def model10D(num_classes=40, **kwargs) -> Model10:
    return Model10(points=1024, class_num=num_classes, embed_dim=32,
                 pre_blocks=[4,4,4], pos_blocks=[2,2,2], k_neighbors=[20,20,20],
                 reducers=[4,2,2], **kwargs)

def model10E(num_classes=40, **kwargs) -> Model10:
    return Model10(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[4,4,4], pos_blocks=[2,2,2], k_neighbors=[20,20,20],
                 reducers=[4,2,2], **kwargs)

def model10F(num_classes=40, **kwargs) -> Model10:
    return Model10(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[4,4,4], pos_blocks=[2,2,2], k_neighbors=[16,16,16],
                 reducers=[4,2,2], **kwargs)

def model10G(num_classes=40, **kwargs) -> Model10:
    return Model10(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[4,4], pos_blocks=[2,2], k_neighbors=[32,32],
                 reducers=[4,4], **kwargs)

def model10H(num_classes=40, **kwargs) -> Model10:
    return Model10(points=1024, class_num=num_classes, embed_dim=64,
