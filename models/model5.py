...
def model5A(num_classes=40, **kwargs) -> Model5:
...
def model5B(num_classes=40, **kwargs) -> Model5:
    return Model5(points=1024, class_num=num_classes, embed_dim=64, heads=4, dim_head=32,
                 pre_blocks=[2,2,2], pos_blocks=[2,2,2], k_neighbors=[16,16,16],
                 reducers=[2,2,2], **kwargs)

def model5C(num_classes=40, **kwargs) -> Model5:
    return Model5(points=1024, class_num=num_classes, embed_dim=64, heads=4, dim_head=24,
                 pre_blocks=[2,2,2], pos_blocks=[2,2,2], k_neighbors=[32,32,32],
                 reducers=[2,2,2], **kwargs)

def model5D(num_classes=40, **kwargs) -> Model5:
    return Model5(points=1024, class_num=num_classes, embed_dim=64, heads=4, dim_head=32,
                 pre_blocks=[3,3,3], pos_blocks=[1,1,1], k_neighbors=[32,32,32],
                 reducers=[2,2,2], **kwargs)

def model5E(num_classes=40, **kwargs) -> Model5:
    return Model5(points=1024, class_num=num_classes, embed_dim=64, heads=4, dim_head=32,
                 pre_blocks=[2,2,2], pos_blocks=[2,2,2], k_neighbors=[16,16,16],
...
if __name__ == '__main__':
    ...
    print("===> testing model5A ...")
    model = model5A()
    out = model(data)
    print(out.shape)

    print("===> testing model5B ...")
    model = model5B()
    out = model(data)
    print(out.shape)

    print("===> testing model5C ...")
    model = model5C()
    out = model(data)
    print(out.shape)

    print("===> testing model5D ...")
    model = model5D()
    out = model(data)
    print(out.shape)
