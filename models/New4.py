...
def new4A(num_classes=40, **kwargs: Any) -> New4:
    return New4(num_classes=num_classes, blocks=[2, 2, 2, 2], reducer=4, k_neighbors=[32,32,32,32], **kwargs)

def new4B(num_classes=40, **kwargs: Any) -> New4:
    return New4(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, k_neighbors=[32,32,32,32], **kwargs)

def new4C(num_classes=40, **kwargs: Any) -> New4:
    return New4(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, k_neighbors=[16,16,16,16], **kwargs)


def new4D(num_classes=40, **kwargs: Any) -> New4:
    return New4(num_classes=num_classes, blocks=[2, 3, 6, 4], reducer=4, k_neighbors=[32,32,32,32], **kwargs)

def new4E(num_classes=40, **kwargs: Any) -> New4:
    return New4(num_classes=num_classes, embed_channel=64, blocks=[1,1,1,1], reducer=4, k_neighbors=[32,32,32,32], **kwargs)
