...
def combine1A(num_classes=40, **kwargs: Any) -> Combine1:
    return Combine1(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, **kwargs)

def combine1Amax(num_classes=40, **kwargs: Any) -> Combine1:
    return Combine1(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, pool="max", **kwargs)

def combine1Bmax(num_classes=40, **kwargs: Any) -> Combine1:
    return Combine1(num_classes=num_classes, blocks=[1, 1, 1, 1], reducer=4, embed_channel=64, pool="max", **kwargs)

def combine1Cmax(num_classes=40, **kwargs: Any) -> Combine1:
    return Combine1(num_classes=num_classes, blocks=[1, 1, 1, 1],
