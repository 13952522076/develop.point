...
def model2A(num_classes=40, **kwargs) -> Model2:
    return Model2(points=1024, class_num=num_classes, embed_dim=64,
...
def model2C(num_classes=40, **kwargs) -> Model2:
    return Model2(points=1024, class_num=num_classes, embed_dim=32,
                 pre_blocks=[1,1,1,1], pos_blocks=[1,1,1,1], k_neighbors=[32,32,32,32],
                 reducers=[2,2,2,2], **kwargs)
...
def model2F(num_classes=40, **kwargs) -> Model2:
    return Model2(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[3,3], pos_blocks=[2,2], k_neighbors=[32,32],
                 reducers=[4,4], **kwargs)

def model2G(num_classes=40, **kwargs) -> Model2:
    return Model2(points=1024, class_num=num_classes, embed_dim=64,
