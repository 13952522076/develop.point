...
def get_parser():
    ...
    parser.add_argument('--model', default='PAConv', help='model name [default: pointnet_cls]')
    parser.add_argument('--num_points', type=int, default=2048, help='Point Number')
    parser.add_argument('--batch_size', type=int, default=32, help='batch size in training')
    parser.add_argument('--test_batch_size', type=int, default=16, help='batch size in training')
    parser.add_argument('--workers', type=int, default=8, help='batch size in training')
...
def _init_():
    ...
    if args.exp_name is None:
        args.exp_name = str(datetime.datetime.now().strftime('%Y%m%d%H%M%S'))
