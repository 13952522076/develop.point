...
def parse_args():
    ...
    parser.add_argument('--data_normalize', action='store_true', default=False, help='normalize data')
    parser.add_argument('--data_dropout', action='store_true', default=False, help='dropout data')
...
def main():
    ...
    train_loader = DataLoader(
        ModelNet40(partition='train', num_points=args.num_points,
                   dropout=args.data_dropout, normalize=args.data_normalize),
