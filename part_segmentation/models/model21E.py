...
class get_model(nn.Module):
    def __init__(self, num_classes=40,points=2048, embed_dim=128, normal_channel=True,
        ...
        self.encoder_stage3 = encoder_stage(anchor_points=points // 64, channel=512,
                                            pre_blocks=3, pos_blocks=3, k_neighbor=32)
        ...
        self.fp1 = PointNetFeaturePropagation(in_channel=256+16+3+input_channel, mlp=[256, 256, 256])
